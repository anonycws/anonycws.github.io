...
\begin{tikzpicture}
  ...
  \begin{axis}[%ybar=1.0pt,
    ...
    xticklabels={wCon \\ \textcolor{brinkpink}{1} \\ \textcolor{cyan}{0}, cCon \\ \textcolor{brinkpink}{1} \\ \textcolor{cyan}{(0, .5]}, wFre \\ \textcolor{brinkpink}{(.109, 1]} \\ \textcolor{cyan}{(.001, .009]}, cFre \\ \textcolor{brinkpink}{(.081, 1]} \\ \textcolor{cyan}{0}, wLen \\ \textcolor{brinkpink}{2} \\ \textcolor{cyan}{(4, 11]}, sLen \\ \textcolor{brinkpink}{(2, 42]} \\ \textcolor{cyan}{(43, 62]}, oDen \\ \textcolor{brinkpink}{0} \\ \textcolor{cyan}{(.0175, .0312]}},
    xtick=data,
    xmajorgrids=true,
    ymajorgrids=true,
    zmajorgrids=true,
