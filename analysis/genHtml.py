...
dict_att2desc = {"wCon":"label sonsistency of word", \
                "cCon":"label sonsistency of character", \
                "wFre":"word frequency in training set", \
                "cFre":"character frequency in training set",\
                "wLen":"the length of text span", \
                "sLen":"the length of sentence",\
                "wDen":"span density in a given sentence",\
